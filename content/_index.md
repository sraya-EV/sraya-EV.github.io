...
sections:
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: |-
        My research focuses in extracellular vesicles in cancer. Extracellular vesicles (EVs) are lipid-coated tiny nanoparticles secreted by cells. EVs are emerging biologics for diagnostics and therapeutics. 
    design:
      columns: '1'
  - block: collection
    id: papers
